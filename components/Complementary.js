...
const Complementary = () => {
  return(
    <div class={`flex flex-col max-w-[360px] min-w-[280px] max-[898px]:hidden`}>
      <div>
        <span>
          <div class="px-4">
          <h4 class="font-semibold">Реклама</h4>
          </div>
          <div class="py-2">
            ...
            <div class="flex p-2 mx-2">
              <div class="w-[40%]">
                <img 
                class="rounded-[12px]" 
                src="https://scontent-fra5-2.xx.fbcdn.net/v/t45.1600-4/308972504_23852411105000070_1115089901466216075_n.png?stp=dst-png_p476x249&_nc_cat=105&ccb=1-7&_nc_sid=eaa83b&_nc_aid=0&_nc_ohc=a5QfCmLKVzMAX_fKIwm&_nc_ht=scontent-fra5-2.xx&oh=00_AfC5tyZ82wiGJT7mKmXSCJR-_Zh9DLL8jI3vhDEmLHjOCw&oe=63F2C844" 
                alt="image"
                />
              </div>
              <div class="pl-3"><span>Build your dream tech career</span></div>
            </div>

            <div class="flex p-2 mx-2">
              <div class="w-[40%] max-h-[120px]">
                <img 
                class="rounded-[12px] max-w-[95%]" 
                src="https://scontent-fra5-2.xx.fbcdn.net/v/t45.1600-4/314318543_23851278706960704_6636373201028724591_n.png?stp=dst-png_p285x285&_nc_cat=111&ccb=1-7&_nc_sid=eaa83b&_nc_ohc=c-_rdSHH71AAX81UyKP&_nc_ht=scontent-fra5-2.xx&oh=00_AfD3iZn6COaIMBqZkDL45sY9ZZPF3Okhyxkzxw-LDP50eg&oe=63F12D96"
                alt="image"
                />
              </div>
              <div class="pl-3"><span>Master in Managment</span></div>
            </div>
...
<div>
  ...
  <div aria-label="Новый вызов" role="button" tabindex="0">
    <svg 
    fill="currentColor" 
    viewBox="0 0 16 16" 
    width="1em" 
  ...
  <div aria-label="Поиск по имени или группе" role="button" tabindex="0">
    <svg 
    fill="currentColor" 
    viewBox="0 0 16 16" 
    width="1em" 
